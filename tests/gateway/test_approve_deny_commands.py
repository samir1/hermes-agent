...
def _clear_approval_state():
    ...
    from hermes_agent.tools.security import approval as mod
...
class TestApproveCommand:
    ...
    async def test_approve_resolves_blocking_approval(self):
        ...
        from hermes_agent.tools.security.approval import _ApprovalEntry, _gateway_queues
...
class TestBlockingApprovalE2E:
    ...
    def test_blocking_approval_timeout(self):
        ...
        def agent_thread():
            ...
            os.environ["HERMES_SESSION_KEY"] = session_key
            try:
                with patch("hermes_agent.tools.security.approval._get_approval_config",
    ...
    def test_parallel_mixed_approve_deny(self):
        ...
        from hermes_agent.tools.security.approval import _gateway_queues
...
class TestFallbackNoCallback:
    ...
    def test_no_callback_returns_approval_required(self):
        ...
        from hermes_agent.tools.security.approval import check_all_command_guards, _pending
