...
class TestIsSkillDisabled:
    ...
    def test_globally_disabled(self, mock_load):
        ...
        from hermes_agent.tools.skills.tool import _is_skill_disabled
...
class TestFindAllSkillsFiltering:
    @patch("hermes_agent.tools.skills.tool._get_disabled_skill_names", return_value={"my-skill"})
    @patch("hermes_agent.tools.skills.tool.skill_matches_platform", return_value=True)
    @patch("hermes_agent.tools.skills.tool.SKILLS_DIR")
    ...
    @patch("hermes_agent.tools.skills.tool._get_disabled_skill_names", return_value=set())
    @patch("hermes_agent.tools.skills.tool.skill_matches_platform", return_value=True)
    @patch("hermes_agent.tools.skills.tool.SKILLS_DIR")
