...
from hermes_agent.cli.repl import ChatConsole
...
def three_source_env(monkeypatch, hub_env):
    ...
    import hermes_agent.tools.skills.hub as hub
    import hermes_agent.tools.skills.sync as skills_sync
...
def test_handle_skills_slash_search_accepts_chatconsole_without_status_errors():
    ...
    with patch("hermes_agent.tools.skills.hub.unified_search", return_value=results), \
         patch("hermes_agent.tools.skills.hub.create_source_router", return_value={}), \
...
def test_do_install_scans_with_resolved_identifier(monkeypatch, tmp_path, hub_env):
    import hermes_agent.tools.skills.guard as guard
    import hermes_agent.tools.skills.hub as hub
