...
from hermes_agent.cli.models.models import validate_requested_model
...
def _patched(func):
    ...
    def wrapper(*args, **kwargs):
        with patch("hermes_agent.cli.models.models.fetch_api_models", return_value=None), \
             patch("hermes_agent.cli.models.models.probe_api_models", return_value=_UNREACHABLE_PROBE):
