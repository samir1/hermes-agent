...
def test_get_available_skills_delegates_to_find_all_skills():
    ...
    with patch("hermes_agent.tools.skills.tool._find_all_skills", return_value=list(_MOCK_SKILLS)):
...
def test_get_available_skills_excludes_disabled():
    ...
    with patch("hermes_agent.tools.skills.tool._find_all_skills", return_value=filtered):
        from hermes_agent.cli.ui.banner import get_available_skills
        result = get_available_skills()
...
def test_get_available_skills_empty_when_no_skills():
    ...
    with patch("hermes_agent.tools.skills.tool._find_all_skills", return_value=[]):
        from hermes_agent.cli.ui.banner import get_available_skills
        result = get_available_skills()
...
def test_get_available_skills_handles_import_failure():
    ...
    with patch("hermes_agent.tools.skills.tool._find_all_skills", side_effect=ImportError("boom")):
        from hermes_agent.cli.ui.banner import get_available_skills
        result = get_available_skills()
...
def test_get_available_skills_null_category_becomes_general():
    ...
    with patch("hermes_agent.tools.skills.tool._find_all_skills", return_value=skills):
        from hermes_agent.cli.ui.banner import get_available_skills
        result = get_available_skills()
