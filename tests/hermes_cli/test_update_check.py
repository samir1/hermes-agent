...
def test_version_string_no_v_prefix():
    ...
    from hermes_agent.cli import __version__
...
def test_check_for_updates_uses_cache(tmp_path, monkeypatch):
    ...
    with patch("hermes_agent.cli.ui.banner.subprocess.run") as mock_run:
...
def test_check_for_updates_expired_cache(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("HERMES_HOME", str(tmp_path))
    with patch("hermes_agent.cli.ui.banner.subprocess.run", return_value=mock_result) as mock_run:
        result = check_for_updates()
...
def test_invalidate_update_cache_clears_all_profiles(tmp_path):
    ...
    from hermes_agent.cli.main import _invalidate_update_cache
