...
class TestDoInstallSkipConfirm:
    ...
    def test_without_skip_confirm_prompts_user(self, mock_input):
        ...
        with patch("hermes_agent.cli.skills_hub._console"), \
             patch("hermes_agent.tools.skills.hub.ensure_hub_dirs"), \
             patch("hermes_agent.tools.skills.hub.GitHubAuth"), \
             patch("hermes_agent.tools.skills.hub.create_source_router") as mock_router, \
...
class TestDoUninstallSkipConfirm:
    ...
    def test_skip_confirm_bypasses_input(self):
        ...
        with patch("hermes_agent.cli.skills_hub._console") as mock_console, \
             patch("hermes_agent.tools.skills.hub.uninstall_skill", return_value=(True, "Removed")) as mock_uninstall, \
    ...
    def test_without_skip_confirm_calls_input(self):
        ...
        from hermes_agent.cli.skills_hub import do_uninstall
        with patch("hermes_agent.cli.skills_hub._console"), \
             patch("hermes_agent.tools.skills.hub.uninstall_skill", return_value=(True, "Removed")), \
    ...
    def test_without_skip_confirm_cancel(self):
        ...
        from hermes_agent.cli.skills_hub import do_uninstall
        with patch("hermes_agent.cli.skills_hub._console"), \
             patch("hermes_agent.tools.skills.hub.uninstall_skill") as mock_uninstall, \
