...
class TestSaveModelChoiceAlwaysDict:
    def test_string_model_becomes_dict(self, config_home):
        ...
        from hermes_agent.cli.auth.auth import _save_model_choice
...
class TestProviderPersistsAfterModelSave:
    def test_api_key_provider_saved_when_model_was_string(self, config_home, monkeypatch):
        ...
        with patch("hermes_agent.cli.auth.auth._prompt_model_selection", return_value="kimi-k2.5"), \
             patch("hermes_agent.cli.auth.auth.deactivate_provider"), \
    ...
    def test_copilot_provider_saved_when_selected(self, config_home):
        ...
        with patch(
            "hermes_agent.cli.auth.auth.resolve_api_key_provider_credentials",
            return_value={
                "provider": "copilot",
            ...
            "hermes_agent.cli.auth.auth._prompt_model_selection",
            return_value="gpt-5.4",
        ), patch(
            "hermes_agent.cli.main._prompt_reasoning_effort_selection",
            return_value="high",
        ), patch(
            "hermes_agent.cli.auth.auth.deactivate_provider",
        ):
    ...
    def test_copilot_acp_provider_saved_when_selected(self, config_home):
        ...
        with patch(
            "hermes_agent.cli.auth.auth.get_external_process_provider_status",
            return_value={
            ...
            "hermes_agent.cli.auth.auth.resolve_external_process_provider_credentials",
            return_value={
    ...
    def test_opencode_go_models_are_selectable_and_persist_normalized(self, config_home, monkeypatch):
        ...
        with patch("hermes_agent.cli.models.models.fetch_api_models", return_value=["opencode-go/kimi-k2.5", "opencode-go/minimax-m2.7"]), \
             patch("hermes_agent.cli.auth.auth._prompt_model_selection", return_value="kimi-k2.5"), \
             patch("hermes_agent.cli.auth.auth.deactivate_provider"), \
             patch("builtins.input", return_value=""):
    ...
    def test_opencode_go_same_provider_switch_recomputes_api_mode(self, config_home, monkeypatch):
        ...
        with patch("hermes_agent.cli.models.models.fetch_api_models", return_value=["opencode-go/kimi-k2.5", "opencode-go/minimax-m2.5"]), \
             patch("hermes_agent.cli.auth.auth._prompt_model_selection", return_value="minimax-m2.5"), \
             patch("hermes_agent.cli.auth.auth.deactivate_provider"), \
             patch("builtins.input", return_value=""):
...
class TestBaseUrlValidation:
    ...
    def test_invalid_base_url_rejected(self, config_home, monkeypatch, capsys):
        ...
        with patch("hermes_agent.cli.auth.auth._prompt_model_selection", return_value="glm-5"), \
             patch("hermes_agent.cli.auth.auth.deactivate_provider"), \
